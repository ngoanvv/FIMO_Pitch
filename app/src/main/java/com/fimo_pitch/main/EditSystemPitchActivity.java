...
public class EditSystemPitchActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Chỉnh sửa hệ thống sân");
        initView();
    }
    public void initView()
    {
        ...
        edtname.setText(mSystemPitch.getName());
        edtphone.setText(mSystemPitch.getPhone());
        edtaddress.setText(mSystemPitch.getAddress());
        edtlat.setText(mSystemPitch.getLat());
        edtlng.setText(mSystemPitch.getLng());
        edtdes.setText(mSystemPitch.getDescription());
    ...
    class UpdateSystem extends AsyncTask<String,String,String>
    {
        ...
        public UpdateSystem(HashMap<String,String> body)
        {
            this.param=body;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if(!s.contains("status:fail")) {
                Intent intent = new Intent(EditSystemPitchActivity.this,SystemManagementActivity.class);
            ...
            {
                if (s.contains("Name System Pitch Already Exists")) Utils.openDialog(EditSystemPitchActivity.this,"Tên Hệ thống sân bị trùng, chọn tên khác");
            }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(EditSystemPitchActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                Response response =
                  client.newCall(NetworkUtils.createPutRequest(API.UpdateSystemPitch+mSystemPitch.getId(), this.param)).execute();
        ...
        switch(v.getId())
        {
            case R.id.btaddSystem :
            {
                if(isFilled())
                {
                    ...
                    new UpdateSystem(param).execute();
                }
                else
                {
                    Utils.openDialog(EditSystemPitchActivity.this,"Hãy điền đầy đủ các thông tin");
                }
                break;
            }
        }
