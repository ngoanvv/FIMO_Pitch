...
public class SearchPitchModel extends SystemPitch{
    ...
    public String getPitch_description() {
        return pitch_description;
    }

    public void setPitch_description(String pitch_description) {
        this.pitch_description = pitch_description;
    }
